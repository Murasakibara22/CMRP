...
<head>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
   <!-- ── PWA ───────────────────────────────────────────── -->
    ...
    <link rel="apple-touch-startup-image" href="/images/icons/android/android-launchericon-512-512.png">

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href="/images/icons/android/android-launchericon-96-96.png">
