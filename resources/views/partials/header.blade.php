            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ asset('logo.jpg') }}" alt="" height="17">
                        </span>
                    </a>
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                     @auth   <span class="badge badge-soft-light fs-13">  Nouvelles</span> @endauth
                                    </div>
                                </div>
                            </div>
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user"
                                ...
                                @elseif(strpos(Auth::user()->photo, "https") !==false )
                                    {{ Auth::user()->photo }}
                                @else
                                https://api.dicebear.com/7.x/initials/svg?seed={{ auth()->user()->nom }}
                                @endif"
                         alt="Header Avatar">
                         @endauth
...
{{-- <livewire:backend.header.modal-notification /> --}}
